...
用法:
    python tools/stereo_s80m/export_calibration.py                 # 设备级 → config/
    python tools/stereo_s80m/export_calibration.py --session data/recordings/222/222_000002
        # 会话级 → calibration/head_stereo.json + calibration/s80m_dump_calib.yaml
    python tools/stereo_s80m/export_calibration.py --output /tmp/calib.json
"""
